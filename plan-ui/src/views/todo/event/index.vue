...
<script>
import { listEvent, getEvent, delEvent, addEvent, updateEvent } from "@/api/todo/event";

export default {
  name: "Event",
  dicts: ['todo_plan_event_status'],
  data() {
    return {
      // 遮罩层
      loading: true,
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('todo/event/export', {
        ...this.queryParams
